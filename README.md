...
uvx --no-cache --from git+https://github.com/laris-co/multi-agent-workflow-kit.git@v0.2.2-alpha multi-agent-kit init
...
```bash
# Use v0.2.2-alpha (latest features)
uvx --no-cache --from git+https://github.com/laris-co/multi-agent-workflow-kit.git@v0.2.2-alpha multi-agent-kit init

# Or with custom prefix (creates: demo-ai-<repo-name>)
uvx --no-cache --from git+https://github.com/laris-co/multi-agent-workflow-kit.git@v0.2.2-alpha multi-agent-kit init --prefix demo
```
