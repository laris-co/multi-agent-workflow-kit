...
uvx --no-cache --from git+https://github.com/laris-co/multi-agent-workflow-kit.git@v0.2.1-alpha multi-agent-kit init
...
uvx --no-cache --from git+https://github.com/laris-co/multi-agent-workflow-kit.git@v0.2.1-alpha multi-agent-kit init --prefix demo
```
